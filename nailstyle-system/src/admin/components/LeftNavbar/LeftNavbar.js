...
const Navbar = (props) => {
  ...
  return (
    <div className="left-parent-container">
      <div className="categories">
        <ul className="links">
          <li>
            <div
              className="link"
              style={props.checkState.bookings ? linkStyles : null}
              onClick={() => trackState(0)}
            >
          ...
          <li>
            <div
              className="link"
              style={props.checkState.customers ? linkStyles : null}
              onClick={() => trackState(1)}
            >
              <BsPeopleFill className="icon"></BsPeopleFill>
              <div className="category-title">Customers</div>
            </div>
          </li>
          <li>
            <div
              className="link"
              style={props.checkState.analytics ? linkStyles : null}
              onClick={() => trackState(2)}
            >
          ...
          <li>
            <div
              className="link"
              style={props.checkState.employee ? linkStyles : null}
              onClick={() => trackState(3)}
            >
