  ...
  return (
    <div className="home-parent-ctn">
        <div className="home-navbar-ctn">
            ...
            <BsList id="mobile-cta" className="mobile-menu" alt="Open Navigation" onClick={() => {
            ...
            <nav>
                ...
                <ul className="home-ctgs">
                    ...
                    <li className="home-link"><a href="#">GALLERY</a></li>
                    <li className="home-link"><a href="#">CONTACT</a></li>

                    <li className="nav-book-btn"><a href="#">BOOK NOW</a></li>
